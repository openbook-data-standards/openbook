...
Phase B questions are recorded through **Q56**. Q46–Q49 and **Q56** are
on the wire. **Q50** is the docs-vs-schema name check in
`tools/validate.py`.
...
OpenAPI · Q55 schema-diff CI at 1.0 · Q56 MCP/plugin discovery `kind`.
