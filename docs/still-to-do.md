...
for maps, not inside the vocab lists (**Q182**, **Q183**). One file per
public list when files exist (**Q187**). First public list name waits
(**Q184**). Not a wire change. No file now. Not Q55. Not position token
lists.

Questions recorded through **Q187**. Catalog pass closed and on the wire.
...
file per public list when files exist (**Q187**). Cite at least one
...
**Next question: Q188.** When files exist, what encoding? Rec: JSON, same as the shared vocab lists; name still waits (**Q184**); no file now. A pasted letter is not implement. Wire is a separate ask.
