...
Phase B questions are recorded through **Q59**. Q46–Q49 are on the wire.
...
(check 8). Protocol-fit leftovers (FIX session, GBFS
nested discovery wrapper, CloudEvents corpus) follow as Q60+.
...
Q58 JSON Patch never (corpus) · Q59 ISO 20022 never (corpus).
