...
| `series` | Live playoff series lead (Q139–Q140). Fixture-keyed. `stage` is the printed round (`seriesGame`). Not this game’s `score`. Not `competitionType` series. Win counts wait |
